...
See the [file upload example](https://github.com/garden-co/jazz2/tree/main/docs/examples/file-upload-react) for a complete React app with image upload, rendering, and deletion.
