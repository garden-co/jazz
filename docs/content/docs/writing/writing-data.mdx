...
db.update(app.documents, documentId, {
  body: { $splice: { at: 120, delete: 5, insert: "world" } },
...
sync, and conflict semantics. See [Editing without materializing](/docs/schemas/large-values#editing-without-materializing)
for text, streams, files, and JSON.
