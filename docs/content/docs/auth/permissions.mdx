...
Each helper preserves its selected operation and each update rule's old/new row
checks. The global helper's TypeScript name check covers the app's declared
