...
Jazz also records who created and last updated each row through the provenance magic columns
...
If backend code should keep backend permissions but still record a user's identity in provenance,
