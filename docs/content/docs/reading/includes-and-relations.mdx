...
Jazz does not generate an inverse or infer names from UUID columns. Existing examples may
retain names such as `todosViaProject` through explicit declarations.
