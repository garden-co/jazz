...
Each framework has a reactive binding that re-renders when query results change. See [Supported Frameworks](/docs/reference/supported-frameworks/overview) for side-by-side examples.
...
<Callout type="info">
  Different framework? Vue, Solid, and per-framework guides live in [Supported
