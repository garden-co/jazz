...
| [todo-client-localfirst-expo](https://github.com/garden-co/jazz/tree/main/examples/todo-client-localfirst-expo)     | Expo (React Native)        | Binding scaffold and integration target. Persistent React Native storage is not implemented, so this is not a deployable runtime example.                                                                                                                                               |
| [todo-client-localfirst-react](https://github.com/garden-co/jazz/tree/main/examples/todo-client-localfirst-react)   | React + Vite               | Fully client-side React app with a device-local secret identity; `useAll` with composable `where()`, `useDb` writes, OPFS persistence, and the development Inspector overlay                                                                                                            |
...
- **The `todo-client-localfirst-*` family** (`-react`, `-svelte`, `-solid`, `-ts`, `-expo`)
  ...
  framework binding. They cover the local-first baseline: device-local identity,
