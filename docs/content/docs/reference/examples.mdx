...
- **The product-shaped examples** (`chat-react`, `world-tour`) are full apps
  that lean on Jazz for a specific real-world pattern: real-time chat with
  invites and canvases, and Vue + maps.
