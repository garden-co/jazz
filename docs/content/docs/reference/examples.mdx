...
| [todo-client-localfirst-expo](https://github.com/garden-co/jazz/tree/main/examples/todo-client-localfirst-expo)     | Expo (React Native)       | New-Architecture/native-package scaffold. The separate capability-gated foreground alpha requires a matching development/release build and trusted platform admission; it is not this example's generic app setup.                                                                      |
