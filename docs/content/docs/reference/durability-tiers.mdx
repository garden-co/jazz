...
| ------------- | ------------------------------------------------------- | --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `tier`        | `"local-first"` \| `"remote"` \| `"remote-if-possible"` | runtime default | Product-level read choice, including how the subscription treats your own local writes. The older values remain available as legacy controls.                                           |
