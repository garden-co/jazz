...
<Tabs
  groupId="jazz-metaframework"
  items={["React (Vite)", "Vue (Vite)", "Svelte (Vite)", "Solid (Vite)", "SvelteKit", "Next.js", "Nuxt", "Expo"]}
  persist
  updateAnchor
>
  ...
  <Tab value="Nuxt">
    ...
    Injects `NUXT_PUBLIC_JAZZ_APP_ID` and `NUXT_PUBLIC_JAZZ_SERVER_URL`, which Nuxt maps to `useRuntimeConfig().public.jazzAppId` and `useRuntimeConfig().public.jazzServerUrl`.
...
| Nuxt      | `NUXT_PUBLIC_JAZZ_APP_ID` | `NUXT_PUBLIC_JAZZ_SERVER_URL` |
