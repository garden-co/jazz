...
<Callout type="info">
  Different framework? Vue, Solid, and per-framework setup guides live in [Supported
  Frameworks](/docs/reference/supported-frameworks/overview).
</Callout>

<Tabs groupId="jazz-framework" items={["React", "Svelte", "Expo", "TypeScript"]} persist updateAnchor>
  <Tab value="React">
    ```bash title="Terminal"
...
<Tabs
  ...
  items={["React", "Svelte", "Expo", "TypeScript"]}
  persist
  updateAnchor
>
  <Tab value="React">
