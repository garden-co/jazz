...
support matrix. See the [Linux native package requirements](https://github.com/garden-co/jazz/blob/main/dev/artifacts/linux-napi/README.md)
...
Every operation requires an explicit [permission](/docs/auth/permissions) grant. Omitted operations are denied, including on tables with no policy declarations. For this quickstart, explicitly allow all four operations:
