...
Jazz supports browser clients through React, Vue, Svelte, Solid, and plain TypeScript, plus Node.js
through the native runtime. React Native and Expo bindings typecheck but do not yet have a working
persistent runtime.
...
<Cards>
  ...
  <Card title="Schema changes" href="/docs/schemas/migrations" />
</Cards>
