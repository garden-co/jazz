...
# In development, connecting the app to a local Jazz server auto-publishes
# the structural schema hash. For an existing deployed schema, create and
# publish the migration edge instead:
