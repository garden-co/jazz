...
schema uses lenses to project those rows into the requested shape; schema versions are not
application branches. Non-adjacent reads compose lenses in sequence to bridge multiple schema
versions.
