...
`pnpm dlx jazz-tools@alpha schema export` prints the compiled schema as JSON to stdout. It
...
The command exports the current local `schema.ts`. To create migrations against a historical
