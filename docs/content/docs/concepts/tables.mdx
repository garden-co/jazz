...
Note: Each row automatically gets an `id` column (ObjectId, UUIDv7) - you don't need to declare it.
...
- Permissions can be set per-row via [ReBAC policies](/docs/internals/rebac-policies)
