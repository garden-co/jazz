...
server, `context.db()` gives you an unscoped local `Db`. [Server Setup](/docs/context-setup/server-setup)
...
- [Server Setup](/docs/context-setup/server-setup)&hairsp;—&hairsp;hosting, sync, and deployment
