...
<Accordions type="single">
  <Accordion title="Client Config">
    ...
    source overrides, see [Client Setup](/docs/context-setup/client-setup#client-config-options).
  </Accordion>
</Accordions>
...
For production deployment and hosting options, see [Server Setup](/docs/context-setup/server-setup).
