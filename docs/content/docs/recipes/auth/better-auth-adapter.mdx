...
Because Better Auth tables are merged into your app schema, they deploy with the application schema
and permissions:
...
See [Schema changes](/docs/schemas/migrations) for the validation and deployment workflow.

## Supported Better Auth features
...
<Callout title="Supported feature scope">
