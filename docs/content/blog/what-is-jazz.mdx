...
"Local-first" means that Jazz offers real durable local state like an embedded database, while automatically syncing to the cloud and other users in the background. This results in an unparalleled "feels like reactive local state" developer experience *and* makes it easy to build snappy, even offline-capable apps.
...
One important thing to note is that Jazz is built
