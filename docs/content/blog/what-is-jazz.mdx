...
Our conclusion from this is that it's up to the database to step up and take on these new
responsiblities, becoming a distributed source of truth for inherently collaborative data.

## Might it be time for Jazz?

If the above resonated, Jazz might already be just what the doctor ordered, but here are a couple
...
- Does more than one user, device, or process regularly touche the same records?
