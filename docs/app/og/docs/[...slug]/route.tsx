...
export async function GET(_req: Request, { params }: RouteContext<"/og/docs/[...slug]">) {
  ...
  const [interRegular, interSemiBold] = await Promise.all([loadInter(), loadInterSemiBold()]);
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(20,106,255,0.18) 0%, rgba(20,106,255,0.04) 50%, transparent 70%)",
          display: "flex",
        }}
      />
      ...
      <div
        style={{
          ...
          height: "500px",
          borderRadius: "50%",
          background: "radial-gradient(circle, rgba(20,106,255,0.08) 0%, transparent 60%)",
          display: "flex",
        }}
      />

      {/* Sync arcs — concentric ring fragments */}
      {[220, 300, 390, 490].map((size, i) => (
        <div
          key={i}
          style={{
            position: "absolute",
            ...
            height: `${size}px`,
            borderRadius: "50%",
            border: `1px solid rgba(20,106,255,${0.15 - i * 0.03})`,
            display: "flex",
          }}
        />
      ))}

      {/* Dotted grid — subtle texture */}
      <div
        style={{
          position: "absolute",
          top: "0",
      ...
      <div
        style={{
          ...
          height: "3px",
          background:
            "linear-gradient(90deg, #146aff 0%, rgba(180,65,235,0.6) 50%, rgba(20,106,255,0.1) 100%)",
          display: "flex",
        }}
      />
