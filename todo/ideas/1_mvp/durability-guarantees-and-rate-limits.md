...
Users need a clear mental model of what's durable and what's not. Once that contract is explicit, we can enforce server-side rate limits and shed load on non-durable writes without data loss concerns.
