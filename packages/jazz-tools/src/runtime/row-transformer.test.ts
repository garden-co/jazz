...
describe("transformRows", () => {
  ...
  it("preserves undefined entries for missing forward array includes", () => {
    const arrayRelationSchema: WasmSchema = {
      users: {
    ...
    const result = transformRows(rows, arrayRelationSchema, "todos", {
      assignees: {
        conditions: [],
        includes: {},
        select: ["id"],
