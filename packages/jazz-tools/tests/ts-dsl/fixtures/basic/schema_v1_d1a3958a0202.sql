...
CREATE TABLE table_with_defaults (
    ...
    json JSON('{"$schema":"http://json-schema.org/draft-07/schema#","properties":{"age":{"type":"number"},"name":{"type":"string"}},"required":["name"],"type":"object"}') DEFAULT '{"name":"default name"}' NOT NULL,
