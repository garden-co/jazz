export const repro3Deps = [
  {
    action: "content",
    id: "co_zFdU3Ftg3FVE7YC3vEJFbhxwYZa",
    header: {
      type: "comap",
      ruleset: {
        type: "group",
        initialAdmin:
          "sealer_zE8htcyeUzezHDpaDVs89QR51MPGvyvVXs6LF8fMeoAvN/signer_z4H3bLup1CzuVqyWH7TUqwWWbsZYtxXSSu1N3ujGwWiVw",
      },
      meta: {
        type: "account",
      },
    ...
    priority: 0,
    new: {
      "sealer_zE8htcyeUzezHDpaDVs89QR51MPGvyvVXs6LF8fMeoAvN/signer_z4H3bLup1CzuVqyWH7TUqwWWbsZYtxXSSu1N3ujGwWiVw_session_zaTssVbb7Cnj":
        {
          after: 0,
          newTransactions: [
            {
              changes:
                '[{"key":"sealer_zE8htcyeUzezHDpaDVs89QR51MPGvyvVXs6LF8fMeoAvN/signer_z4H3bLup1CzuVqyWH7TUqwWWbsZYtxXSSu1N3ujGwWiVw","op":"set","value":"admin"}]',
              madeAt: 1759431644133,
              privacy: "trusting",
            },
            {
              changes:
                '[{"key":"key_z51ErAUxbYsyFyViv1_for_sealer_zE8htcyeUzezHDpaDVs89QR51MPGvyvVXs6LF8fMeoAvN/signer_z4H3bLup1CzuVqyWH7TUqwWWbsZYtxXSSu1N3ujGwWiVw","op":"set","value":"sealed_UQVARYBk3dGqscCRMmhtGhX6WAWd22_B68btjs196vCVTNwwLvqbOaqev2ftyDc6Pc66c_Sehn4SJv2x5BCD8k52Jo4mc4hRjYA=="}]',
              madeAt: 1759431644154,
              privacy: "trusting",
            },
            {
              changes:
                '[{"key":"readKey","op":"set","value":"key_z51ErAUxbYsyFyViv1"}]',
              madeAt: 1759431644159,
              privacy: "trusting",
            },
            {
              changes:
                '[{"key":"child_co_zZpN6txA4nuvMrHx53wfKkKzSbv","op":"set","value":"extend"}]',
              madeAt: 1759431644193,
              privacy: "trusting",
            },
            {
              changes:
                '[{"key":"root","op":"set","value":"co_zJf2JaWR3Qw12MfqdJHo4WiJm3"}]',
              madeAt: 1759431644249,
              privacy: "trusting",
            },
            {
              changes:
                '[{"key":"profile","op":"set","value":"co_zQitm8oSD3MtmnbAZtcktehfz9z"}]',
              madeAt: 1759431645269,
              privacy: "trusting",
            },
          ],
          lastSignature:
            "signature_z5gsuT9NeVLDbJJDcP2g1vHFpDoysaB2U61jaXjyaZgaCjNdv22VLgoKACLLPB3wFWkydzDUUyZo92d9FeczFQvre",
        },
    },
  },
  {
    action: "content",
    id: "co_zMYFsNDsR8JUQUgRZ3KdP2dJLHh",
    header: {
      type: "comap",
      ruleset: {
        type: "group",
        initialAdmin:
          "sealer_z4VwQPuNQk57q5NebD841fuiVFDkFrenQGiHaF7vfbue7/signer_z2aHsMYb1hiqgTssd2chSmUr3Asac2LwYZjmdPZRRkh6n",
      },
      meta: {
        type: "account",
      },
    ...
    priority: 0,
    new: {
      "sealer_z4VwQPuNQk57q5NebD841fuiVFDkFrenQGiHaF7vfbue7/signer_z2aHsMYb1hiqgTssd2chSmUr3Asac2LwYZjmdPZRRkh6n_session_zUr5jpeuz1Yb":
        {
          after: 0,
          newTransactions: [
            {
              privacy: "trusting",
              madeAt: 1757252563854,
              changes:
                '[{"key":"sealer_z4VwQPuNQk57q5NebD841fuiVFDkFrenQGiHaF7vfbue7/signer_z2aHsMYb1hiqgTssd2chSmUr3Asac2LwYZjmdPZRRkh6n","op":"set","value":"admin"}]',
            },
            {
              privacy: "trusting",
              madeAt: 1757252563855,
              changes:
                '[{"key":"key_z211LuyUy7UTCuwn1m_for_sealer_z4VwQPuNQk57q5NebD841fuiVFDkFrenQGiHaF7vfbue7/signer_z2aHsMYb1hiqgTssd2chSmUr3Asac2LwYZjmdPZRRkh6n","op":"set","value":"sealed_Udxwo1hIkDjaOntZvH80OQPmc0T_9ZRv_Tpevicz-bN6Ad5azwP1pfxALanvcvmYmP7DRLL2F80Mgb7AvBxH6t2vy_iT6WfntJA=="}]',
            },
            {
              privacy: "trusting",
              madeAt: 1757252563855,
              changes:
                '[{"key":"readKey","op":"set","value":"key_z211LuyUy7UTCuwn1m"}]',
            },
            {
              privacy: "trusting",
              madeAt: 1757252563858,
              changes:
                '[{"key":"profile","op":"set","value":"co_zS1tQJS15KVmnD8LMaXXeK6FUPx"}]',
            },
          ],
          lastSignature:
            "signature_z3yNXeECJ2BH8wZgSksNwos5C5oN8pobbU4taidQAzAotvkyHRGXVsbCTaaYKCVt8AvRhXkx3ndLjosCYgWRePyWU",
        },
      "sealer_z4VwQPuNQk57q5NebD841fuiVFDkFrenQGiHaF7vfbue7/signer_z2aHsMYb1hiqgTssd2chSmUr3Asac2LwYZjmdPZRRkh6n_session_zJzD6gEQYLD5":
        {
          after: 0,
          newTransactions: [
            {
              privacy: "trusting",
              madeAt: 1757510692601,
              changes:
                '[{"key":"root","op":"set","value":"co_zVDpWd9dNhQhc2rB9iPt8AAj91y"}]',
            },
          ],
          lastSignature:
            "signature_z3g1qYAJumQRzqRSRHU14njn9CkLWJb3BddiXAdM3yFCGGsA17g2xZV39FBnfmk1pFE7XEYPTmrNfXtEqcJSrU1LB",
        },
    },
  },
  {
    action: "content",
    id: "co_zZpN6txA4nuvMrHx53wfKkKzSbv",
    header: {
      type: "comap",
      ruleset: {
        type: "group",
        initialAdmin: "co_zFdU3Ftg3FVE7YC3vEJFbhxwYZa",
      },
      meta: null,
      createdAt: "2025-10-02T19:00:44.166Z",
      uniqueness: "z2RLxXpRLUqjQd6mQV",
    },
    priority: 0,
    new: {
      co_zFdU3Ftg3FVE7YC3vEJFbhxwYZa_session_zaTssVbb7Cnj: {
        after: 0,
        newTransactions: [
          {
            changes:
          ...
          {
            changes:
              '[{"key":"readKey","op":"set","value":"key_z3VotF1Cs2LW7rz7E"}]',
        ...
        lastSignature:
          "signature_zJxFytkASPdj5nr5KArgejKKXkUBnrAJxsWQQ9q21Qy9CrdJzhgJz8rXyv8zXFCHjo6M7J99jUZgJw9kWZp7jsKU",
      },
      co_zFdU3Ftg3FVE7YC3vEJFbhxwYZa_session_zGpGzuZ1wYJN: {
        after: 0,
        newTransactions: [
          {
            changes:
        ...
        lastSignature:
          "signature_z5siWtAuroAUZKqNPjBEcrQRGC7BxEdGr24R2EKC7fBcKfU2M4F7mC5r1dttLaGvFJXenA7zJumffLwj3NadEczsi",
      },
      co_zFdU3Ftg3FVE7YC3vEJFbhxwYZa_session_zF1ohMmNWs23: {
        after: 0,
        newTransactions: [
          {
            changes:
        ...
        lastSignature:
          "signature_z3pqYSTieA1YZJWgABqLWMxfVDgNjk2kcKXyHUmh3c57cCGuHZGSBwC77JCbVvsetJQsiwt9GBYujhyvHz3XN7iZ5",
      },
      co_zFdU3Ftg3FVE7YC3vEJFbhxwYZa_session_zgVC649kPMyj: {
        after: 0,
        newTransactions: [
          {
            changes:
        ...
        lastSignature:
          "signature_zqrbFxKU21ntQceXGTkWnztj6v4yjCp8Yhjrtua1xA5ugw2za66PVxYSZ9AH7ZA1QKR2sZGV3qP1cuJHUVusdsnC",
      },
    },
  },
];
  ...
  msg: {
    ...
    new: {
      co_zFdU3Ftg3FVE7YC3vEJFbhxwYZa_session_zF1ohMmNWs23: {
        ...
        lastSignature:
          "signature_zGzmjzgSH1U5ao5jMXubhaVhwYrLUf1PeJceZvkM4LPXSW3PzkzTrF8S5Ldchmo1B8L1nBfMCWGYXWrKec9fNYHi",
      },
    },
  },
  content: [
