...
// Automated testing checks Java_com_rncojsoncore_CojsonCoreRnModule and cojsoncorern
// by comparing the whole line here.
/*
Java_com_rncojsoncore_CojsonCoreRnModule_nativeMultiply(JNIEnv *env, jclass type, jdouble a, jdouble b) {
...
Java_com_rncojsoncore_CojsonCoreRnModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_rncojsoncore_CojsonCoreRnModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
