...
namespace uniffi_generated {
    ...
    */
    ...
    public:
        NativeCojsonCoreRnSpecJSI(const ObjCTurboModule::InitParams &params);
    ...
    NativeCojsonCoreRnSpecJSI::NativeCojsonCoreRnSpecJSI(const ObjCTurboModule::InitParams &params)
