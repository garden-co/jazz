...
import installer from "./NativeRnCojsonCoreSpec";
...
export * from "./generated/cojson_core_uniffi";

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as cojson_core_uniffi from "./generated/cojson_core_uniffi";
...
if (!initialized) {
  cojson_core_uniffi.default.initialize();
  initialized = true;
}
