...
interface NativeModuleInterface {
  ...
  ubrn_uniffi_cojson_core_uniffi_fn_func_ed25519_sign(
    signingKey: Uint8Array,
    message: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus,
  ): Uint8Array;
  ubrn_uniffi_cojson_core_uniffi_fn_func_ed25519_signature_from_bytes(
    bytes: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus,
  ): Uint8Array;
  ubrn_uniffi_cojson_core_uniffi_fn_func_ed25519_signing_key_from_bytes(
    bytes: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus,
  ): Uint8Array;
  ubrn_uniffi_cojson_core_uniffi_fn_func_ed25519_signing_key_sign(
    signingKey: Uint8Array,
    message: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus,
  ): Uint8Array;
  ubrn_uniffi_cojson_core_uniffi_fn_func_ed25519_signing_key_to_public(
    signingKey: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus,
  ): Uint8Array;
  ubrn_uniffi_cojson_core_uniffi_fn_func_ed25519_verify(
    verifyingKey: Uint8Array,
    message: Uint8Array,
    signature: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus,
  ): number;
  ubrn_uniffi_cojson_core_uniffi_fn_func_ed25519_verifying_key(
    signingKey: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus,
  ): Uint8Array;
  ubrn_uniffi_cojson_core_uniffi_fn_func_ed25519_verifying_key_from_bytes(
    bytes: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus,
  ): Uint8Array;
  ubrn_uniffi_cojson_core_uniffi_fn_func_new_ed25519_signing_key(
    uniffi_out_err: UniffiRustCallStatus,
  ): Uint8Array;
  ubrn_uniffi_cojson_core_uniffi_checksum_func_ed25519_sign(): number;
  ubrn_uniffi_cojson_core_uniffi_checksum_func_ed25519_signature_from_bytes(): number;
  ubrn_uniffi_cojson_core_uniffi_checksum_func_ed25519_signing_key_from_bytes(): number;
  ubrn_uniffi_cojson_core_uniffi_checksum_func_ed25519_signing_key_sign(): number;
  ubrn_uniffi_cojson_core_uniffi_checksum_func_ed25519_signing_key_to_public(): number;
  ubrn_uniffi_cojson_core_uniffi_checksum_func_ed25519_verify(): number;
  ubrn_uniffi_cojson_core_uniffi_checksum_func_ed25519_verifying_key(): number;
  ubrn_uniffi_cojson_core_uniffi_checksum_func_ed25519_verifying_key_from_bytes(): number;
  ubrn_uniffi_cojson_core_uniffi_checksum_func_new_ed25519_signing_key(): number;
  ubrn_ffi_cojson_core_uniffi_uniffi_contract_version(): number;
}

// Casting globalThis to any allows us to look for `NativeCojsonCoreUniffi`
// if it was added via JSI.
//
// We use a getter here rather than simply `globalThis.NativeCojsonCoreUniffi` so that
// if/when the startup sequence isn't just so, an empty value isn't inadvertantly cached.
const getter: () => NativeModuleInterface = () =>
  (globalThis as any).NativeCojsonCoreUniffi;
