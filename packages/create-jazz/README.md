...
During interactive setup, you can also opt in to Jazz coding skills for your AI agent. This runs
[TanStack Intent](https://tanstack.com/intent/latest) after dependencies are installed and adds
version-aware skill loading guidance to the generated project's agent configuration. The option is
off by default.
