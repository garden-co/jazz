  ...
  test("loading a large coValue from storage", async () => {
    ...
    expect(
      ...
      [
        ...
        "client -> storage | CONTENT Map header: true new: After: 0 New: 38",
        "client -> server | CONTENT Map header: true new: After: 0 New: 38",
        "client -> storage | CONTENT Map header: false new: After: 38 New: 39",
        "client -> server | CONTENT Map header: false new: After: 38 New: 39",
        "client -> storage | CONTENT Map header: false new: After: 77 New: 23",
        "client -> server | CONTENT Map header: false new: After: 77 New: 23",
        "server -> client | KNOWN Group sessions: header/5",
        "server -> storage | CONTENT Group header: true new: After: 0 New: 5",
        "server -> client | KNOWN Map sessions: header/38",
        "server -> storage | CONTENT Map header: true new: After: 0 New: 38",
        "server -> client | KNOWN Map sessions: header/77",
        "server -> storage | CONTENT Map header: false new: After: 38 New: 39",
        "server -> client | KNOWN Map sessions: header/100",
        "server -> storage | CONTENT Map header: false new: After: 77 New: 23",
      ]
    `);
    ...
    expect(
      ...
      [
        ...
        "storage -> client | CONTENT Map header: true new: After: 0 New: 77 expectContentUntil: header/100",
        "client -> server | LOAD Map sessions: header/100",
        "server -> client | KNOWN Group sessions: header/5",
        "server -> client | KNOWN Map sessions: header/100",
        "storage -> client | CONTENT Map header: true new: After: 77 New: 23",
      ]
    `);
  });
