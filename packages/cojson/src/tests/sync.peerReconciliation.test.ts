    ...
    expect(
      SyncMessagesLog.getMessages({
        ...
        ProfileGroup: client.node.expectProfileLoaded(client.accountID).group
          .core,
        Inbox: client.node.expectInboxLoaded(client.accountID).core,
        InboxGroup: client.node.expectInboxLoaded(client.accountID).group.core,
        Group: group.core,
        Map: map.core,
      }),
    ).toMatchInlineSnapshot(`
      [
        ...
        "client -> server | LOAD InboxGroup sessions: header/5",
        "server -> client | KNOWN InboxGroup sessions: empty",
        "client -> server | LOAD Inbox sessions: header/0",
        "server -> client | KNOWN Inbox sessions: empty",
        "client -> server | LOAD Group sessions: header/3",
        "server -> client | KNOWN Group sessions: empty",
        "client -> server | LOAD Map sessions: header/2",
        "server -> client | KNOWN Map sessions: empty",
        ...
        "server -> client | LOAD InboxGroup sessions: empty",
        "client -> server | CONTENT Map header: true new: After: 0 New: 2",
        "server -> client | KNOWN CORRECTION Inbox sessions: empty",
        ...
        "server -> client | LOAD Account sessions: empty",
        "client -> server | CONTENT Map header: true new: After: 0 New: 2",
        "server -> client | KNOWN CORRECTION InboxGroup sessions: empty",
        "client -> server | CONTENT Account header: true new: After: 0 New: 5",
        "server -> client | LOAD InboxGroup sessions: empty",
        "client -> server | CONTENT InboxGroup header: true new: After: 0 New: 5",
        "server -> client | KNOWN CORRECTION Inbox sessions: empty",
