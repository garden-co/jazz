  ...
  test("large coValue upload streaming", async () => {
    ...
    expect(
      ...
      [
        ...
        "server -> client | CONTENT Map header: false new: After: 0 New: 74",
        "server -> client | CONTENT Map header: false new: After: 74 New: 74",
        "server -> client | CONTENT Map header: false new: After: 148 New: 74",
        "server -> client | CONTENT Map header: false new: After: 222 New: 74",
        "server -> client | CONTENT Map header: false new: After: 296 New: 74",
        "server -> client | CONTENT Map header: false new: After: 370 New: 74",
        "server -> client | CONTENT Map header: false new: After: 444 New: 74",
        "server -> client | CONTENT Map header: false new: After: 518 New: 74",
        "server -> client | CONTENT Map header: false new: After: 592 New: 74",
        "server -> client | CONTENT Map header: false new: After: 666 New: 74",
        "server -> client | CONTENT Map header: false new: After: 740 New: 74",
        "server -> client | CONTENT Map header: false new: After: 814 New: 74",
        "server -> client | CONTENT Map header: false new: After: 888 New: 74",
        "server -> client | CONTENT Map header: false new: After: 962 New: 62",
        "client -> server | KNOWN Group sessions: header/5",
        "client -> server | KNOWN Map sessions: header/0",
        "client -> server | KNOWN Map sessions: header/74",
        "client -> server | KNOWN Map sessions: header/148",
        "client -> server | KNOWN Map sessions: header/222",
        "client -> server | KNOWN Map sessions: header/296",
        "client -> server | KNOWN Map sessions: header/370",
        "client -> server | KNOWN Map sessions: header/444",
        "client -> server | KNOWN Map sessions: header/518",
        "client -> server | KNOWN Map sessions: header/592",
        "client -> server | KNOWN Map sessions: header/666",
        "client -> server | KNOWN Map sessions: header/740",
        "client -> server | KNOWN Map sessions: header/814",
        "client -> server | KNOWN Map sessions: header/888",
        "client -> server | KNOWN Map sessions: header/962",
