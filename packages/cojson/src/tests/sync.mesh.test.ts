  ...
  test("coValue created on a different edge with parent groups loading", async () => {
    ...
    expect(
      ...
      [
        ...
        "edge-france -> storage | CONTENT Group header: true new: After: 3 New: 1",
        "edge-france -> storage | CONTENT ParentGroup header: true new: After: 5 New: 1",
        "edge-france -> storage | CONTENT Group header: true new: After: 4 New: 1",
        "edge-france -> storage | CONTENT Map header: true new: After: 0 New: 1",
        "edge-france -> core | CONTENT Map header: true new: After: 0 New: 1",
