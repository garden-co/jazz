  ...
  test("large coValue streaming from an edge to the core server and a client at the same time", async () => {
    ...
    expect(
      ...
      [
        ...
        "edge -> storage | CONTENT Map header: true new: After: 0 New: 38",
        "edge -> storage | CONTENT Map header: false new: After: 38 New: 39",
        "edge -> storage | CONTENT Map header: false new: After: 77 New: 23",
      ]
    `);
    ...
    expect(
      ...
      [
        ...
        "storage -> edge | CONTENT Map header: true new: After: 0 New: 77 expectContentUntil: header/100",
        ...
        "edge -> client | CONTENT Map header: false new: After: 0 New: 77",
        ...
        "client -> edge | KNOWN Map sessions: header/77",
        "client -> storage | CONTENT Map header: false new: After: 0 New: 77",
        "storage -> edge | CONTENT Map header: true new: After: 77 New: 23",
        "edge -> client | CONTENT Map header: false new: After: 77 New: 23",
        "edge -> core | CONTENT Group header: true new: After: 0 New: 5",
        "edge -> core | CONTENT Map header: true new:  expectContentUntil: header/100",
        "edge -> core | CONTENT Map header: false new: After: 0 New: 77",
        "edge -> core | CONTENT Map header: false new: After: 77 New: 23",
        ...
        "core -> edge | KNOWN Map sessions: header/77",
        "core -> storage | CONTENT Map header: false new: After: 0 New: 77",
        "core -> edge | KNOWN Map sessions: header/100",
        "core -> storage | CONTENT Map header: false new: After: 77 New: 23",
      ]
    `);
