...
test("chunks transactions when when the chars are longer than MAX_RECOMMENDED_TX_SIZE", async () => {
  ...
  expect(
    ...
    [
      "client -> storage | CONTENT CoPlainText header: true new: After: 0 New: 5",
      "client -> storage | CONTENT CoPlainText header: false new: After: 5 New: 5",
      "client -> storage | CONTENT CoPlainText header: false new: After: 10 New: 5",
      "client -> storage | CONTENT CoPlainText header: false new: After: 15 New: 5",
      "client -> storage | CONTENT CoPlainText header: false new: After: 20 New: 5",
      "client -> storage | CONTENT CoPlainText header: false new: After: 25 New: 5",
      "client -> storage | CONTENT CoPlainText header: false new: After: 30 New: 5",
      "client -> storage | CONTENT CoPlainText header: false new: After: 35 New: 5",
      "client -> storage | CONTENT CoPlainText header: false new: After: 40 New: 2",
      "client -> storage | LOAD CoPlainText sessions: empty",
      "storage -> client | CONTENT CoPlainText header: true new: After: 0 New: 10 expectContentUntil: header/42",
      "storage -> client | CONTENT CoPlainText header: true new: After: 10 New: 5",
      "storage -> client | CONTENT CoPlainText header: true new: After: 15 New: 5",
      "storage -> client | CONTENT CoPlainText header: true new: After: 20 New: 5",
      "storage -> client | CONTENT CoPlainText header: true new: After: 25 New: 5",
      "storage -> client | CONTENT CoPlainText header: true new: After: 30 New: 5",
      "storage -> client | CONTENT CoPlainText header: true new: After: 35 New: 5",
      "storage -> client | CONTENT CoPlainText header: true new: After: 40 New: 2",
    ]
  `);
});
