...
test("should load dependencies correctly (group inheritance)", async () => {
  ...
  expect(
    ...
    [
      ...
      "client -> CONTENT Group header: true new: After: 3 New: 1",
      "client -> CONTENT ParentGroup header: true new: After: 3 New: 1",
      "client -> CONTENT Group header: true new: After: 4 New: 1",
      "client -> CONTENT Map header: true new: After: 0 New: 1",
    ]
  `);
...
test("should recover from data loss", async () => {
  ...
  expect(
    ...
    [
      "client -> CONTENT Group header: true new: After: 0 New: 3",
      "client -> CONTENT Map header: true new: After: 0 New: 1",
      "client -> CONTENT Map header: true new: After: 3 New: 1",
...
test("should sync and load accounts from storage", async () => {
  ...
  expect(
    ...
    [
      ...
      "client -> CONTENT Account header: true new: After: 3 New: 1",
    ]
  `);
