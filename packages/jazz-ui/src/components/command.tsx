...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      "bg-popover text-popover-foreground border-border flex h-full w-full flex-col overflow-hidden rounded-lg border shadow-md",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    className="border-b-border flex items-center border-b px-3"
    cmdk-input-wrapper=""
  >
