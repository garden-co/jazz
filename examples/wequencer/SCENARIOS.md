...
| `permission-roles`      | creator, editor, viewer               | one shared session               | editor changes pads; viewer attempts the same; creator changes membership            | editor write settles; viewer write is rejected; visibility follows membership after refresh/reconnect               |
