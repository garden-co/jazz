...
edits, reconnect convergence, viewer denial, and advisory presence. The
benchmark uses the same session/track/pad query shapes and asserts their ordering
and subscription delivery contract.
