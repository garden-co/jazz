...
A benchmark-only example representing a synthetic resource catalogue with deep
permissions. It deliberately has no application UI. All data and identifiers are
