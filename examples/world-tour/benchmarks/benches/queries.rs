...
fn calendar_window(bencher: divan::Bencher<'_, '_>, leg_count: usize) {
    let fixture = Fixture::new(leg_count);
    bencher.bench_local(|| divan::black_box(fixture.calendar_window_count()));
}

#[divan::bench(args = [128, 4096])]
fn map_viewport(bencher: divan::Bencher<'_, '_>, leg_count: usize) {
    let fixture = Fixture::new(leg_count);
