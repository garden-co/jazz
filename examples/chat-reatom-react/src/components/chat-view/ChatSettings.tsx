...
import { allProfilesQuery, getChatMembersQuery, getChatRowsQuery } from "@/model/queries";
...
const ChatSettingsContent = reatomComponent(
  ({ chatId, onOpenChange }: { chatId: string; onOpenChange: (open: boolean) => void }) => {
