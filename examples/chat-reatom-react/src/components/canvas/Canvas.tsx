...
import { allProfilesQuery, getCanvasRowsQuery, getCanvasStrokesQuery } from "@/model/queries";
...
export const CollaborativeCanvas = reatomComponent(
  ({
    canvasId,
    showControls = true,
    className = "",
    ...
    const canvasRows = getCanvasRowsQuery(canvasId)();
    const canvasReady = canvasRows.length > 0;

    const profiles = allProfilesQuery();
    ...
    const allStrokes = getCanvasStrokesQuery(canvasId)();
    ...
    const handlePointerDown = (event: PointerEvent<HTMLCanvasElement>) => {
      ...
      try {
        ...
        // pointer capture may fail if already released
      }
