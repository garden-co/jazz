...
function DepositIcon({ type, dim }: { type: string; dim?: boolean }) {
  ...
  return <canvas ref={canvasRef} width={12} height={12} className={styles.depositIcon} />;
}
...
function FuelBar({ fuel }: { fuel: number }) {
  ...
  return (
    <div className={styles.fuelBar} style={{ "--bar-colour": barColour } as React.CSSProperties}>
      ...
      {remotePlayers.length > 0 && (
        <div className={styles.panelRight}>
          ...
          >
            ...
            <span className={styles.playerName}>{localPlayerName || "you"}</span>
