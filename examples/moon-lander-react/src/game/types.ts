...
export interface SceneContext {
  ...
  /** Per-instance animation state (sprite frame counters). */
  spriteAnim: import("./sprites").SpriteAnimationState;
  /** Per-instance camera tracking (unwrapped parallax). */
  cameraTracking: import("./terrain").CameraTrackingState;
}
