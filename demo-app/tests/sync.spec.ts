...
test.describe('Groove Sync', () => {
  ...
  // TODO: This test requires WasmSyncedLocalNode to fully implement sync
  // (applying incoming SSE events to the database and pushing writes to server)
  test.skip('data syncs between two tabs', async ({ browser }) => {
    const context1 = await browser.newContext();
    const context2 = await browser.newContext();
