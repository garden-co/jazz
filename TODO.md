...
- [**storage-backend-rocksdb-surrealkv**](todo/ideas/1_mvp/storage-backend-rocksdb-surrealkv.md) — Replace Fjall with RocksDB on the server and evaluate SurrealKV as the RN storage backend.
