...
type FixtureModule = {
  ...
  recordSameRuntimeWakeBoundary(): Promise<void>;
...
export async function recordSameRuntimeWakeBoundary(): Promise<void> {
  await fixtureModule().recordSameRuntimeWakeBoundary();
}
