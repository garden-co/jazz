    ...
    def do_POST(self):
        ...
        try:
            ...
            approved = ({
                ...
                **{key: event[key] for key in ("origin", "role", "pageRun", "phase", "elapsedMs", "workerElapsedMs", "direction", "messageType", "frameCount", "frameBytes", "errorKind", "outcome") if key in event},
