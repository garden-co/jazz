...
metadata = json.loads(Path('dev/benchmarks/alpha54-backfill.json').read_text())
...
Path('target/alpha54-backfill-provenance.json').write_text(json.dumps(metadata, indent=2) + '\n')
