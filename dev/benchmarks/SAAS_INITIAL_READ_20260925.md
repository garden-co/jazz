...
Update: #3456 implements the one-shot part as an explicit `resultOnly: true`
mode, with a measured 3.30× page-read gain on main `5b6417fe5`. Ordinary reads
keep filling the offline cache. The live-subscription handoff below remains a
proposal; see [the page-read measurement](SAAS_AUTHORITY_PAGE_20260925.md).
