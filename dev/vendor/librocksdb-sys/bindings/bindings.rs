...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rocksdb_import_column_family_options_t {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rocksdb_export_import_files_metadata_t {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Copy, Clone)]
...
unsafe extern "C" {
    pub fn rocksdb_checkpoint_export_column_family(
        checkpoint: *mut rocksdb_checkpoint_t,
        column_family: *mut rocksdb_column_family_handle_t,
        export_dir: *const libc::c_char,
        errptr: *mut *mut libc::c_char,
    ) -> *mut rocksdb_export_import_files_metadata_t;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn rocksdb_create_column_family_with_import(
        db: *mut rocksdb_t,
        column_family_options: *mut rocksdb_options_t,
        column_family_name: *const libc::c_char,
        import_options: *mut rocksdb_import_column_family_options_t,
        metadata: *mut rocksdb_export_import_files_metadata_t,
        errptr: *mut *mut libc::c_char,
    ) -> *mut rocksdb_column_family_handle_t;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn rocksdb_flushjobinfo_flush_reason(info: *const rocksdb_flushjobinfo_t) -> u32;
}
unsafe extern "C" {
    pub fn rocksdb_status_ptr_get_error(
        status: *mut rocksdb_status_ptr_t,
        errptr: *mut *mut libc::c_char,
    );
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn rocksdb_subcompactionjobinfo_compaction_reason(
        info: *const rocksdb_subcompactionjobinfo_t,
    ) -> u32;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn rocksdb_options_add_compact_on_deletion_collector_factory_min_file_size(
        arg1: *mut rocksdb_options_t,
        window_size: usize,
        num_dels_trigger: usize,
        deletion_ratio: f64,
...
unsafe extern "C" {
    pub fn rocksdb_livefiles_create() -> *mut rocksdb_livefiles_t;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn rocksdb_livefiles_smallest_seqno(
        arg1: *const rocksdb_livefiles_t,
        index: libc::c_int,
    ) -> u64;
}
unsafe extern "C" {
    pub fn rocksdb_livefiles_largest_seqno(
        arg1: *const rocksdb_livefiles_t,
        index: libc::c_int,
    ) -> u64;
}
...
unsafe extern "C" {
    pub fn rocksdb_livefile_create() -> *mut rocksdb_livefile_t;
}
unsafe extern "C" {
    pub fn rocksdb_livefile_set_column_family_name(
        arg1: *mut rocksdb_livefile_t,
        arg2: *const libc::c_char,
    );
}
unsafe extern "C" {
    pub fn rocksdb_livefile_set_level(arg1: *mut rocksdb_livefile_t, arg2: libc::c_int);
}
unsafe extern "C" {
    pub fn rocksdb_livefile_set_name(arg1: *mut rocksdb_livefile_t, arg2: *const libc::c_char);
}
unsafe extern "C" {
    pub fn rocksdb_livefile_set_directory(arg1: *mut rocksdb_livefile_t, arg2: *const libc::c_char);
}
unsafe extern "C" {
    pub fn rocksdb_livefile_set_size(arg1: *mut rocksdb_livefile_t, arg2: usize);
}
unsafe extern "C" {
    pub fn rocksdb_livefile_set_smallest_key(
        arg1: *mut rocksdb_livefile_t,
        arg2: *const libc::c_char,
        arg3: usize,
    );
...
unsafe extern "C" {
    pub fn rocksdb_livefile_set_largest_key(
        arg1: *mut rocksdb_livefile_t,
        arg2: *const libc::c_char,
        arg3: usize,
    );
...
unsafe extern "C" {
    pub fn rocksdb_livefile_set_smallest_seqno(arg1: *mut rocksdb_livefile_t, arg2: u64);
}
unsafe extern "C" {
    pub fn rocksdb_livefile_set_largest_seqno(arg1: *mut rocksdb_livefile_t, arg2: u64);
}
unsafe extern "C" {
    pub fn rocksdb_livefile_set_num_entries(arg1: *mut rocksdb_livefile_t, arg2: u64);
}
unsafe extern "C" {
    pub fn rocksdb_livefile_set_num_deletions(arg1: *mut rocksdb_livefile_t, arg2: u64);
}
unsafe extern "C" {
    pub fn rocksdb_livefile_destroy(arg1: *mut rocksdb_livefile_t);
}
unsafe extern "C" {
    pub fn rocksdb_livefiles_add(arg1: *mut rocksdb_livefiles_t, arg2: *mut rocksdb_livefile_t);
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn rocksdb_import_column_family_options_create()
    -> *mut rocksdb_import_column_family_options_t;
}
unsafe extern "C" {
    pub fn rocksdb_import_column_family_options_set_move_files(
        arg1: *mut rocksdb_import_column_family_options_t,
        arg2: libc::c_uchar,
    );
}
unsafe extern "C" {
    pub fn rocksdb_import_column_family_options_destroy(
        arg1: *mut rocksdb_import_column_family_options_t,
    );
}
unsafe extern "C" {
    pub fn rocksdb_export_import_files_metadata_create()
    -> *mut rocksdb_export_import_files_metadata_t;
}
unsafe extern "C" {
    pub fn rocksdb_export_import_files_metadata_get_db_comparator_name(
        arg1: *mut rocksdb_export_import_files_metadata_t,
    ) -> *mut libc::c_char;
}
unsafe extern "C" {
    pub fn rocksdb_export_import_files_metadata_set_db_comparator_name(
        arg1: *mut rocksdb_export_import_files_metadata_t,
        arg2: *const libc::c_char,
    );
}
unsafe extern "C" {
    pub fn rocksdb_export_import_files_metadata_get_files(
        arg1: *mut rocksdb_export_import_files_metadata_t,
    ) -> *mut rocksdb_livefiles_t;
}
unsafe extern "C" {
    pub fn rocksdb_export_import_files_metadata_set_files(
        arg1: *mut rocksdb_export_import_files_metadata_t,
        arg2: *mut rocksdb_livefiles_t,
    );
}
unsafe extern "C" {
    pub fn rocksdb_export_import_files_metadata_destroy(
        arg1: *mut rocksdb_export_import_files_metadata_t,
    );
}
unsafe extern "C" {
