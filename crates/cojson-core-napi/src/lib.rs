use cojson_core::core::{
  ...
  SessionLogInternal, SessionMapImpl, Signature, SignerID, SignerSecret,
  Transaction as RustTransaction, TransactionMode,
};
...
impl SessionLog {
  ...
  pub fn add_new_private_transaction(
    ...
    let result = match transaction {
      RustTransaction::Private(private_tx) => PrivateTransactionResult {
