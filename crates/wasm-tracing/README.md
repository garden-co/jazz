...
- [#1786](https://github.com/garden-co/jazz/issues/1786): expose
  `#[tracing::instrument]` traces in the console and decide whether the config
  should follow an upstream tracing crate.
