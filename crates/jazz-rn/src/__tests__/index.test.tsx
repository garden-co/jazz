...
describe('jazz-rn package entrypoint', () => {
  it('installs and initializes the generated crate before exposing bindings', async () => {
    ...
    expect(mintAnonymousToken('secret', 'app', 60, 123n)).toBe(
      'anonymous-token'
    );
    expect(generated.mintAnonymousToken).toHaveBeenCalledWith(
      'secret',
      'app',
      60,
      123n
    );
    expect(jazzRn.jazz_rn.mintAnonymousToken).toBe(
      generated.mintAnonymousToken
    );
