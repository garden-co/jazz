...
typedef void (*UniffiCallbackInterfaceSubscriptionCallbackMethod0)(
    ...
    RustCallStatus *rust_call_status);
typedef void (*UniffiCallbackInterfaceSyncMessageCallbackMethod0)(
    uint64_t uniffi_handle, RustBuffer destination_kind,
    RustBuffer destination_id, RustBuffer payload_json, int8_t is_catalogue,
...
typedef struct UniffiVTableCallbackInterfaceSyncMessageCallback {
  UniffiCallbackInterfaceSyncMessageCallbackMethod0 on_sync_message;
  UniffiCallbackInterfaceFree uniffi_free;
} UniffiVTableCallbackInterfaceSyncMessageCallback;
void *uniffi_jazz_rn_fn_clone_rnruntime(void *ptr,
                                        RustCallStatus *uniffi_out_err);
void uniffi_jazz_rn_fn_free_rnruntime(void *ptr,
                                      RustCallStatus *uniffi_out_err);
void *uniffi_jazz_rn_fn_constructor_rnruntime_new(
    RustBuffer schema_json, RustBuffer app_id, RustBuffer jazz_env,
    RustBuffer user_branch, RustBuffer tier, RustBuffer data_path,
    RustCallStatus *uniffi_out_err);
RustBuffer
uniffi_jazz_rn_fn_method_rnruntime_add_client(void *ptr,
                                              RustCallStatus *uniffi_out_err);
void uniffi_jazz_rn_fn_method_rnruntime_add_server(
    void *ptr, RustCallStatus *uniffi_out_err);
void uniffi_jazz_rn_fn_method_rnruntime_batched_tick(
    void *ptr, RustCallStatus *uniffi_out_err);
void uniffi_jazz_rn_fn_method_rnruntime_close(void *ptr,
                                              RustCallStatus *uniffi_out_err);
void uniffi_jazz_rn_fn_method_rnruntime_delete(void *ptr, RustBuffer object_id,
                                               RustCallStatus *uniffi_out_err);
void uniffi_jazz_rn_fn_method_rnruntime_flush(void *ptr,
                                              RustCallStatus *uniffi_out_err);
RustBuffer uniffi_jazz_rn_fn_method_rnruntime_get_schema_hash(
    void *ptr, RustCallStatus *uniffi_out_err);
RustBuffer
uniffi_jazz_rn_fn_method_rnruntime_insert(void *ptr, RustBuffer table,
                                          RustBuffer values_json,
                                          RustCallStatus *uniffi_out_err);
void uniffi_jazz_rn_fn_method_rnruntime_on_batched_tick_needed(
    void *ptr, RustBuffer callback, RustCallStatus *uniffi_out_err);
void uniffi_jazz_rn_fn_method_rnruntime_on_sync_message_received(
    void *ptr, RustBuffer message_json, RustCallStatus *uniffi_out_err);
void uniffi_jazz_rn_fn_method_rnruntime_on_sync_message_received_from_client(
    void *ptr, RustBuffer client_id, RustBuffer message_json,
    RustCallStatus *uniffi_out_err);
void uniffi_jazz_rn_fn_method_rnruntime_on_sync_message_to_send(
    void *ptr, RustBuffer callback, RustCallStatus *uniffi_out_err);
RustBuffer uniffi_jazz_rn_fn_method_rnruntime_query(
    void *ptr, RustBuffer query_json, RustBuffer session_json, RustBuffer tier,
    RustCallStatus *uniffi_out_err);
void uniffi_jazz_rn_fn_method_rnruntime_remove_server(
    void *ptr, RustCallStatus *uniffi_out_err);
void uniffi_jazz_rn_fn_method_rnruntime_set_client_role(
    void *ptr, RustBuffer client_id, RustBuffer role,
    RustCallStatus *uniffi_out_err);
uint64_t uniffi_jazz_rn_fn_method_rnruntime_subscribe(
    void *ptr, RustBuffer query_json, uint64_t callback,
    RustBuffer session_json, RustBuffer tier, RustCallStatus *uniffi_out_err);
void uniffi_jazz_rn_fn_method_rnruntime_unsubscribe(
    void *ptr, uint64_t handle, RustCallStatus *uniffi_out_err);
void uniffi_jazz_rn_fn_method_rnruntime_update(void *ptr, RustBuffer object_id,
                                               RustBuffer values_json,
                                               RustCallStatus *uniffi_out_err);
...
void uniffi_jazz_rn_fn_init_callback_vtable_syncmessagecallback(
    UniffiVTableCallbackInterfaceSyncMessageCallback *vtable);
int64_t
...
double ffi_jazz_rn_rust_future_complete_f64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_jazz_rn_rust_future_poll_pointer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_jazz_rn_rust_future_cancel_pointer(
    /*handle*/ uint64_t handle);
void ffi_jazz_rn_rust_future_free_pointer(
    /*handle*/ uint64_t handle);
void *ffi_jazz_rn_rust_future_complete_pointer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
...
uint16_t uniffi_jazz_rn_checksum_method_rnruntime_on_sync_message_to_send();
...
uint16_t uniffi_jazz_rn_checksum_method_syncmessagecallback_on_sync_message();
...
// Callback function:
// uniffi::jazz_rn::st::foreignfuture::foreignfuture::free::UniffiCallbackInterfaceFree
//
// We have the following constraints:
// - we need to pass a function pointer to Rust.
// - we need a jsi::Runtime and jsi::Function to call into JS.
...
// We then give the `callback` function pointer to Rust which will call the
// lambda sometime in the future.
namespace uniffi::jazz_rn::st::foreignfuture::foreignfuture::free {
using namespace facebook;
...
makeCallbackFunction( // uniffi::jazz_rn::st::foreignfuture::foreignfuture::free
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
  if (rsLambda != nullptr) {
...
// Callback function:
// uniffi::jazz_rn::st::vtablecallbackinterfacesyncmessagecallback::vtablecallbackinterfacesyncmessagecallback::free::UniffiCallbackInterfaceFree
//
// We have the following constraints:
// - we need to pass a function pointer to Rust.
// - we need a jsi::Runtime and jsi::Function to call into JS.
...
// We then give the `callback` function pointer to Rust which will call the
// lambda sometime in the future.
namespace uniffi::jazz_rn::st::vtablecallbackinterfacesyncmessagecallback::
    vtablecallbackinterfacesyncmessagecallback::free {
using namespace facebook;
...
static UniffiCallbackInterfaceFree
makeCallbackFunction( // uniffi::jazz_rn::st::vtablecallbackinterfacesyncmessagecallback::vtablecallbackinterfacesyncmessagecallback::free
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
  if (rsLambda != nullptr) {
...
static void cleanup() {
  ...
  // uniffi::jazz_rn::st::vtablecallbackinterfacesyncmessagecallback::vtablecallbackinterfacesyncmessagecallback::free
namespace uniffi::jazz_rn {
using namespace facebook;
using CallInvoker = uniffi_runtime::UniffiCallInvoker;
...
template <> struct Bridging<UniffiForeignFuture> {
  static UniffiForeignFuture fromJs(jsi::Runtime &rt,
    ...
    rsObject.free = uniffi::jazz_rn::st::foreignfuture::foreignfuture::free::
...
template <> struct Bridging<UniffiForeignFutureCompleteU8> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::jazz_rn::Bridging<UniffiForeignFutureStructU8>::fromJs(
...
template <> struct Bridging<UniffiForeignFutureCompleteI8> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::jazz_rn::Bridging<UniffiForeignFutureStructI8>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteU16> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::jazz_rn::Bridging<UniffiForeignFutureStructU16>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteI16> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::jazz_rn::Bridging<UniffiForeignFutureStructI16>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteU32> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::jazz_rn::Bridging<UniffiForeignFutureStructU32>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteI32> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::jazz_rn::Bridging<UniffiForeignFutureStructI32>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteU64> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::jazz_rn::Bridging<UniffiForeignFutureStructU64>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteI64> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::jazz_rn::Bridging<UniffiForeignFutureStructI64>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteF32> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::jazz_rn::Bridging<UniffiForeignFutureStructF32>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteF64> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::jazz_rn::Bridging<UniffiForeignFutureStructF64>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompletePointer> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::jazz_rn::Bridging<UniffiForeignFutureStructPointer>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteRustBuffer> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::jazz_rn::Bridging<UniffiForeignFutureStructRustBuffer>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteVoid> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::jazz_rn::Bridging<UniffiForeignFutureStructVoid>::fromJs(
             rt, callInvoker, args[1]));
  ...
  // Implementation of callback function calling from Rust to JS
  // CallbackInterfaceBatchedTickCallbackMethod0

// Callback function:
// uniffi::jazz_rn::cb::callbackinterfacebatchedtickcallbackmethod0::UniffiCallbackInterfaceBatchedTickCallbackMethod0
//
// We have the following constraints:
// - we need to pass a function pointer to Rust.
// - we need a jsi::Runtime and jsi::Function to call into JS.
...
static UniffiCallbackInterfaceBatchedTickCallbackMethod0
makeCallbackFunction( // uniffi::jazz_rn::cb::callbackinterfacebatchedtickcallbackmethod0
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
  if (rsLambda != nullptr) {
...
static void cleanup() {
  ...
  // Implementation of callback function calling from Rust to JS
  // CallbackInterfaceSubscriptionCallbackMethod0

// Callback function:
// uniffi::jazz_rn::cb::callbackinterfacesubscriptioncallbackmethod0::UniffiCallbackInterfaceSubscriptionCallbackMethod0
//
// We have the following constraints:
// - we need to pass a function pointer to Rust.
// - we need a jsi::Runtime and jsi::Function to call into JS.
...
static UniffiCallbackInterfaceSubscriptionCallbackMethod0
makeCallbackFunction( // uniffi::jazz_rn::cb::callbackinterfacesubscriptioncallbackmethod0
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
  if (rsLambda != nullptr) {
...
static void cleanup() {
  ...
  // Implementation of callback function calling from Rust to JS
  // CallbackInterfaceSyncMessageCallbackMethod0

// Callback function:
// uniffi::jazz_rn::cb::callbackinterfacesyncmessagecallbackmethod0::UniffiCallbackInterfaceSyncMessageCallbackMethod0
//
// We have the following constraints:
// - we need to pass a function pointer to Rust.
// - we need a jsi::Runtime and jsi::Function to call into JS.
...
// We then give the `callback` function pointer to Rust which will call the
// lambda sometime in the future.
namespace uniffi::jazz_rn::cb::callbackinterfacesyncmessagecallbackmethod0 {
using namespace facebook;

// We need to store a lambda in a global so we can call it from
// a function pointer. The function pointer is passed to Rust.
static std::function<void(uint64_t, RustBuffer, RustBuffer, RustBuffer, int8_t,
                          void *, RustCallStatus *)>
    rsLambda = nullptr;
...
static void body(jsi::Runtime &rt,
                 std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
                 std::shared_ptr<jsi::Value> callbackValue,
                 uint64_t rs_uniffiHandle, RustBuffer rs_destinationKind,
                 RustBuffer rs_destinationId, RustBuffer rs_payloadJson,
                 int8_t rs_isCatalogue, void *rs_uniffiOutReturn,
                 RustCallStatus *uniffi_call_status) {
  ...
  auto js_uniffiHandle =
      uniffi_jsi::Bridging<uint64_t>::toJs(rt, callInvoker, rs_uniffiHandle);
  auto js_destinationKind = uniffi::jazz_rn::Bridging<RustBuffer>::toJs(
      rt, callInvoker, rs_destinationKind);
  auto js_destinationId = uniffi::jazz_rn::Bridging<RustBuffer>::toJs(
      rt, callInvoker, rs_destinationId);
  auto js_payloadJson = uniffi::jazz_rn::Bridging<RustBuffer>::toJs(
      rt, callInvoker, rs_payloadJson);
  auto js_isCatalogue =
      uniffi_jsi::Bridging<int8_t>::toJs(rt, callInvoker, rs_isCatalogue);
  ...
  try {
    ...
    auto cb = callbackValue->asObject(rt).asFunction(rt);
    auto uniffiResult =
        cb.call(rt, js_uniffiHandle, js_destinationKind, js_destinationId,
                js_payloadJson, js_isCatalogue);
    ...
    std::cout << "Error in callback "
                 "UniffiCallbackInterfaceSyncMessageCallbackMethod0: "
              << error.what() << std::endl;
    throw error;
  }
}

static void callback(uint64_t rs_uniffiHandle, RustBuffer rs_destinationKind,
                     RustBuffer rs_destinationId, RustBuffer rs_payloadJson,
                     int8_t rs_isCatalogue, void *rs_uniffiOutReturn,
                     RustCallStatus *uniffi_call_status) {
  // If the runtime has shutdown, then there is no point in trying to
  ...
  // The runtime, the actual callback jsi::funtion, and the callInvoker
  // are all in the lambda.
  rsLambda(rs_uniffiHandle, rs_destinationKind, rs_destinationId,
           rs_payloadJson, rs_isCatalogue, rs_uniffiOutReturn,
           uniffi_call_status);
}

static UniffiCallbackInterfaceSyncMessageCallbackMethod0
makeCallbackFunction( // uniffi::jazz_rn::cb::callbackinterfacesyncmessagecallbackmethod0
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
  if (rsLambda != nullptr) {
  ...
  rsLambda = [&rt, callInvoker, callbackValue](
    ...
    // arguments into JSI values and calling the callback.
    uniffi_runtime::UniffiCallFunc jsLambda =
        [callInvoker, callbackValue, rs_uniffiHandle, rs_destinationKind,
         rs_destinationId, rs_payloadJson, rs_isCatalogue, rs_uniffiOutReturn,
         uniffi_call_status](jsi::Runtime &rt) mutable {
          body(rt, callInvoker, callbackValue, rs_uniffiHandle,
               rs_destinationKind, rs_destinationId, rs_payloadJson,
               rs_isCatalogue, rs_uniffiOutReturn, uniffi_call_status);
        };
    // We'll then call that lambda from the callInvoker which will
    // look after calling it on the correct thread.
    callInvoker->invokeBlocking(rt, jsLambda);
...
template <> struct Bridging<UniffiVTableCallbackInterfaceBatchedTickCallback> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    // Create the vtable from the js callbacks.
    rsObject.request_batched_tick = uniffi::jazz_rn::cb::
        callbackinterfacebatchedtickcallbackmethod0::makeCallbackFunction(
            rt, callInvoker, jsObject.getProperty(rt, "requestBatchedTick"));
...
template <> struct Bridging<UniffiVTableCallbackInterfaceSubscriptionCallback> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    // Create the vtable from the js callbacks.
    rsObject.on_update = uniffi::jazz_rn::cb::
        callbackinterfacesubscriptioncallbackmethod0::makeCallbackFunction(
...
template <> struct Bridging<UniffiVTableCallbackInterfaceSyncMessageCallback> {
  static UniffiVTableCallbackInterfaceSyncMessageCallback
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
         const jsi::Value &jsValue) {
    // Check if the input is an object
    if (!jsValue.isObject()) {
    ...
    // Create the vtable struct
    UniffiVTableCallbackInterfaceSyncMessageCallback rsObject;

    // Create the vtable from the js callbacks.
    rsObject.on_sync_message = uniffi::jazz_rn::cb::
        callbackinterfacesyncmessagecallbackmethod0::makeCallbackFunction(
            rt, callInvoker, jsObject.getProperty(rt, "onSyncMessage"));
    rsObject.uniffi_free =
        uniffi::jazz_rn::st::vtablecallbackinterfacesyncmessagecallback::
            vtablecallbackinterfacesyncmessagecallback::free::
                makeCallbackFunction(rt, callInvoker,
                                     jsObject.getProperty(rt, "uniffiFree"));
...
NativeJazzRn::NativeJazzRn(
  ...
  props["ubrn_uniffi_jazz_rn_fn_method_rnruntime_on_sync_message_to_send"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "ubrn_uniffi_jazz_rn_fn_method_"
                                        "rnruntime_on_sync_message_to_send"),
          2,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_jazz_rn_fn_method_rnruntime_on_sync_message_to_send(
                    rt, thisVal, args, count);
          });
  ...
  props["ubrn_uniffi_jazz_rn_fn_init_callback_vtable_syncmessagecallback"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "ubrn_uniffi_jazz_rn_fn_init_callback_"
                                        "vtable_syncmessagecallback"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_jazz_rn_fn_init_callback_vtable_syncmessagecallback(
                    rt, thisVal, args, count);
          });
  ...
  props["ubrn_uniffi_jazz_rn_checksum_method_rnruntime_on_sync_message_to_"
      ...
      [this](jsi::Runtime &rt, const jsi::Value &thisVal,
             const jsi::Value *args, size_t count) -> jsi::Value {
        return this
            ->cpp_uniffi_jazz_rn_checksum_method_rnruntime_on_sync_message_to_send(
                rt, thisVal, args, count);
      });
  ...
  props["ubrn_uniffi_jazz_rn_checksum_method_syncmessagecallback_on_sync_"
        "message"] = jsi::Function::createFromHostFunction(
      rt,
      jsi::PropNameID::forAscii(rt, "ubrn_uniffi_jazz_rn_checksum_method_"
                                    "syncmessagecallback_on_sync_message"),
      0,
      [this](jsi::Runtime &rt, const jsi::Value &thisVal,
             const jsi::Value *args, size_t count) -> jsi::Value {
        return this
            ->cpp_uniffi_jazz_rn_checksum_method_syncmessagecallback_on_sync_message(
                rt, thisVal, args, count);
      });
...
NativeJazzRn::~NativeJazzRn() {
  ...
  uniffi::jazz_rn::st::foreignfuture::foreignfuture::free::cleanup();
  uniffi::jazz_rn::st::vtablecallbackinterfacebatchedtickcallback::
      vtablecallbackinterfacebatchedtickcallback::free::cleanup();
  uniffi::jazz_rn::st::vtablecallbackinterfacesubscriptioncallback::
      vtablecallbackinterfacesubscriptioncallback::free::cleanup();
  uniffi::jazz_rn::st::vtablecallbackinterfacesyncmessagecallback::
      vtablecallbackinterfacesyncmessagecallback::free::cleanup();
  // Cleanup for callback function CallbackInterfaceBatchedTickCallbackMethod0
  uniffi::jazz_rn::cb::callbackinterfacebatchedtickcallbackmethod0::cleanup();
  // Cleanup for callback function CallbackInterfaceSubscriptionCallbackMethod0
  uniffi::jazz_rn::cb::callbackinterfacesubscriptioncallbackmethod0::cleanup();
  // Cleanup for callback function CallbackInterfaceSyncMessageCallbackMethod0
  uniffi::jazz_rn::cb::callbackinterfacesyncmessagecallbackmethod0::cleanup();
}
...
NativeJazzRn::cpp_uniffi_internal_fn_method_rnruntime_ffi__bless_pointer(
  ...
  auto static destructor = [](uint64_t p) {
    ...
    uniffi_jazz_rn_fn_free_rnruntime(pointer, &status);
  };
  auto ptrObj =
...
jsi::Value
NativeJazzRn::cpp_uniffi_jazz_rn_fn_method_rnruntime_on_sync_message_to_send(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  RustCallStatus status =
      uniffi::jazz_rn::Bridging<RustCallStatus>::rustSuccess(rt);
  uniffi_jazz_rn_fn_method_rnruntime_on_sync_message_to_send(
      uniffi_jsi::Bridging<void *>::fromJs(rt, callInvoker, args[0]),
      uniffi::jazz_rn::Bridging<RustBuffer>::fromJs(rt, callInvoker, args[1]),
      &status);
  uniffi::jazz_rn::Bridging<RustCallStatus>::copyIntoJs(rt, callInvoker, status,
...
jsi::Value
NativeJazzRn::cpp_uniffi_jazz_rn_fn_init_callback_vtable_syncmessagecallback(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  auto vtableInstance = uniffi::jazz_rn::Bridging<
      UniffiVTableCallbackInterfaceSyncMessageCallback>::fromJs(rt, callInvoker,
                                                                args[0]);

  std::lock_guard<std::mutex> lock(uniffi::jazz_rn::registry::vtableMutex);
  uniffi_jazz_rn_fn_init_callback_vtable_syncmessagecallback(
      uniffi::jazz_rn::registry::putTable(
          "UniffiVTableCallbackInterfaceSyncMessageCallback", vtableInstance));
  return jsi::Value::undefined();
}
