...
const rustSource = readFileSync(
  resolve(root, 'crates/jazz-native-relay/src/lib.rs'),
  'utf8'
);
const abi = /^pub const NATIVE_RELAY_ABI_VERSION: u16 = (\d+);$/m.exec(
  rustSource
)?.[1];
if (!abi)
  throw new Error('could not read NATIVE_RELAY_ABI_VERSION from Rust source');
