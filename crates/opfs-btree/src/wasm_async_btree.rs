...
use crate::{
    BTreeError,
    async_db::{AsyncPageBTree, AsyncPageBTreeOptions},
...
impl WasmAsyncBTree {
    ...
    pub async fn delete(&mut self, key: Vec<u8>) -> Result<bool, JsValue> {
        self.inner
            .delete(&key)
            .await
            .map_err(|e| JsValue::from_str(&e.to_string()))
