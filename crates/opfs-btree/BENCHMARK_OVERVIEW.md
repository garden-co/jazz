...
| Scenario                          | Value Size (bytes) | opfs-btree native | opfs-btree wasm/opfs | bf-tree native | rocksdb native | fjall native | fjall native | Notes          |
| --------------------------------- | -----------------: | ----------------: | -------------------: | -------------: | -------------: | -----------: | -----------: | -------------- |
...
[13] `fjall`/`fjall` native columns were refreshed on 2026-02-16 after dependency updates
to `fjall=0.20.1` and `fjall=3.0.2` by rerunning native Criterion harnesses with
`cargo +1.91.0 bench` and `JAZZ_COMPARE_ENGINES=fjall,fjall`.
