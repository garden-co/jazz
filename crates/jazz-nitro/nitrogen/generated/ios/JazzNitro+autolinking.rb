...
#   load 'nitrogen/generated/ios/JazzNitro+autolinking.rb'
#   add_nitrogen_files(spec)
# end
# ```

def add_nitrogen_files(spec)
  Pod::UI.puts "[NitroModules] 🔥 JazzNitro is boosted by nitro!"
  ...
  spec.vendored_libraries = current_vendored_libraries + [
    File.join(rust_lib_dir, "libJazzNitro_rust.a")
  ]
end
