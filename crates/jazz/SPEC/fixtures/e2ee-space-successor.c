/* Independent JE2C v1 space-successor transcript. Emit raw bytes; base64 externally. */
#include <stdint.h>
#include <stdio.h>
#include <string.h>
#define ROOT "11111111-1111-4111-8111-111111111111"
#define EPOCH "22222222-2222-4222-8222-222222222222"
#define PREDECESSOR "33333333-3333-4333-8333-333333333333"
#define DEVICE "44444444-4444-4444-8444-444444444444"
#define ACCOUNT_EPOCH "55555555-5555-4555-8555-555555555555"
#define SUCCESSOR "66666666-6666-4666-8666-666666666666"
...
int main(void) {
  const char *fields[] = {"fixture", "jazz.e2ee.space.v1", SCOPE, IDENTIFIER,
    "__e2ee_spaces", ROOT, "[\"successor\",\"" SUCCESSOR "\",\"signature\"]", EPOCH,
    "[\"account-id\",\"" DEVICE "\",\"" ACCOUNT_EPOCH "\"]"};
  uint32_t length = 5;
  ...
  field(PREDECESSOR);
  field("[]");
  field("[[\"account-id\",\"" ACCOUNT_EPOCH "\"]]");
  const unsigned char tails[] = {0xaa, 0xbb, 0xcc};
  for (unsigned i = 0; i < 3; i++) { size(1); fwrite(&tails[i], 1, 1, stdout); }
