//! Resolve logical query sources to physical, inline, or settled row-set graphs.
//!
//! This stage applies read-view, durability, branch, projection, and access-path
//! choices. It consumes normalized source requests but does not normalize query
//! syntax or materialize engine output into public rows.
    ...
    S: OrderedKvStorage,
{
    ...
    pub(crate) fn branch_current_source_graph(
        &mut self,
        request: &SourceRequest,
        table: &TableSchema,
        branch: &BranchRecord,
    ...
    pub(crate) fn branch_overlay_deletion_current_graph(
        &mut self,
        request: &SourceRequest,
        table: &TableSchema,
        branch_id: BranchId,
    ...
    pub(crate) fn branch_overlay_deletion_current_graph_for_table(
        &self,
