...
use super::query_engine::{
    ...
    AppProjectionTree, AppRowOutputRequest, AppRowSchema, AsyncSourcePreparer, CapabilityReport,
    ...
    SchemaProjection, SettledBindingRows, SortDirection as NormalizedSortDirection,
    SourceAuthorizationRequest, SourceExpr, SourceGap, SourceId, SourceMetadataFields,
