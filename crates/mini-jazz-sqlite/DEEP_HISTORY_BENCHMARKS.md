...
| Append    | total loop                 |    7360 ms |    7406 ms |    7687 ms |    7609 ms |    7855 ms |   7653 ms |
| Append    | write only                 |     812 ms |     623 ms |     725 ms |     767 ms |     758 ms |   3406 ms |
| Append    | avg loop/update            |    3.31 ms |    3.33 ms |    3.45 ms |    3.42 ms |    3.53 ms |   3.44 ms |
| Append    | avg write/update           |    0.37 ms |    0.28 ms |    0.33 ms |    0.34 ms |    0.34 ms |   1.53 ms |
| Append    | sampled receive            |    6544 ms |    6780 ms |    6959 ms |    6839 ms |    7092 ms |   4245 ms |
| Append    | live receive avg           |    1091 ms |    1130 ms |    1160 ms |    1140 ms |    1182 ms |    707 ms |
| Append    | live receive p50           |     886 ms |     924 ms |     974 ms |     969 ms |     989 ms |    819 ms |
| Append    | live receive p95           |    3303 ms |    3350 ms |    3382 ms |    3369 ms |    3554 ms |   1390 ms |
| Append    | cold load                  |    1898 ms |    1967 ms |    2081 ms |    1961 ms |    2034 ms |   2137 ms |
| Append    | current read               |    0.15 ms |    0.15 ms |    0.24 ms |    0.15 ms |    0.14 ms |  51.60 ms |
| Append    | historical read avg        |        N/A |        N/A |        N/A |        N/A |   79.22 ms |       N/A |
| Append    | tx info avg                |        N/A |        N/A |        N/A |        N/A |    0.34 ms |       N/A |
...
| Append    | block-native export        |        N/A |        N/A |        N/A |        N/A |   22.34 ms |       N/A |
| Append    | block-native import        |        N/A |        N/A |        N/A |        N/A |  182.35 ms |       N/A |
| Append    | block-native blocks        |        N/A |        N/A |        N/A |        N/A |          1 |       N/A |
| Append    | block-native payload bytes |        N/A |        N/A |        N/A |        N/A |     70,162 |       N/A |
...
| Automerge | total loop                 |    7589 ms |    7528 ms |    8000 ms |    7999 ms |    8257 ms | 18,519 ms |
| Automerge | write only                 |     811 ms |     817 ms |     958 ms |     969 ms |     913 ms |   9019 ms |
| Automerge | avg loop/update            |    2.62 ms |    2.60 ms |    2.76 ms |    2.76 ms |    2.85 ms |   6.39 ms |
| Automerge | avg write/update           |    0.28 ms |    0.28 ms |    0.33 ms |    0.33 ms |    0.31 ms |   3.11 ms |
| Automerge | sampled receive            |    6774 ms |    6707 ms |    7038 ms |    7025 ms |    7237 ms |   9497 ms |
| Automerge | live receive avg           |    1129 ms |    1118 ms |    1173 ms |    1171 ms |    1206 ms |   1583 ms |
| Automerge | live receive p50           |     977 ms |     884 ms |     940 ms |     938 ms |     957 ms |   2090 ms |
| Automerge | live receive p95           |    3511 ms |    3429 ms |    3547 ms |    3532 ms |    3669 ms |   3271 ms |
| Automerge | cold load                  |    1895 ms |    1902 ms |    2024 ms |    2031 ms |    2074 ms |   7311 ms |
| Automerge | current read               |    0.14 ms |    0.14 ms |    0.14 ms |    0.13 ms |    0.14 ms |  41.52 ms |
| Automerge | historical read avg        |        N/A |        N/A |        N/A |        N/A |   79.40 ms |       N/A |
| Automerge | tx info avg                |        N/A |        N/A |        N/A |        N/A |    0.50 ms |       N/A |
...
| Automerge | block-native export        |        N/A |        N/A |        N/A |        N/A |   27.30 ms |       N/A |
| Automerge | block-native import        |        N/A |        N/A |        N/A |        N/A |  201.90 ms |       N/A |
| Automerge | block-native blocks        |        N/A |        N/A |        N/A |        N/A |          1 |       N/A |
| Automerge | block-native payload bytes |        N/A |        N/A |        N/A |        N/A |     90,982 |       N/A |
...
| Canvas    | total loop                 |    7801 ms |    7896 ms |    8459 ms |    8455 ms |    8657 ms | 15,234 ms |
| Canvas    | write only                 |    1043 ms |     766 ms |     912 ms |     903 ms |     882 ms |   5217 ms |
...
| Canvas    | live receive p95           |    3026 ms |    3159 ms |    3292 ms |    3274 ms |    3363 ms |   4394 ms |
| Canvas    | cold load                  |    2007 ms |    2072 ms |    2217 ms |    2236 ms |    2286 ms |   5479 ms |
| Canvas    | current read               |    0.11 ms |    0.14 ms |    0.13 ms |    0.13 ms |    0.14 ms |   0.18 ms |
| Canvas    | historical read avg        |        N/A |        N/A |        N/A |        N/A |  117.78 ms |       N/A |
...
| Canvas    | block-native export        |        N/A |        N/A |        N/A |        N/A |   31.25 ms |       N/A |
| Canvas    | block-native import        |        N/A |        N/A |        N/A |        N/A |  211.66 ms |       N/A |
