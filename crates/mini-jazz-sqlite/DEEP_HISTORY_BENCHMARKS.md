...
| total loop / update           |    3.45 ms |   3.57 ms |   0.51 ms |    0.40 ms |    0.35 ms |    0.15 ms |    0.15 ms |    0.22 ms |
...
| current read                  |    0.14 ms |   0.15 ms |   0.22 ms |    0.21 ms |    0.28 ms |    0.29 ms |    0.25 ms |    0.33 ms |
| historical read avg           |  693.96 ms |  41.18 ms |  37.03 ms |   36.42 ms |    1.11 ms |    1.15 ms |    1.12 ms |    2.91 ms |
...
| native sync bytes             | 15,235,071 | 5,486,681 |   104,635 |    104,669 |     60,707 |     60,449 |     60,541 |     36,131 |
...
| current read                |    0.14 ms |   0.13 ms |   0.19 ms |    0.18 ms |    0.29 ms |    0.24 ms |    0.26 ms |    0.11 ms |
| historical read avg         | 1148.49 ms |  60.26 ms |  57.28 ms |   56.72 ms |    1.40 ms |    1.40 ms |    1.46 ms |    3.70 ms |
| tx info avg                 |    1.84 ms |   0.32 ms |   0.30 ms |    0.30 ms |    0.29 ms |    0.29 ms |    0.30 ms |    0.42 ms |
...
| native sync bytes           |  4,152,081 | 1,229,154 |   143,135 |    143,917 |     80,124 |     79,749 |     79,988 |     56,935 |
| live database / source gzip |     10.73x |     3.28x |     0.34x |      0.34x |      0.27x |      0.27x |      0.27x |      0.34x |
...
| total loop / update           |    2.18 ms |  2.16 ms |   2.16 ms |    0.43 ms |    0.25 ms |    0.10 ms |    0.09 ms |    0.09 ms |
...
| historical read avg           | 2080.19 ms | 98.32 ms |  98.32 ms |   95.77 ms |    1.91 ms |    1.77 ms |    1.95 ms |    1.92 ms |
| tx info avg                   |    2.35 ms |  0.39 ms |   0.39 ms |    0.39 ms |    0.41 ms |    0.38 ms |    0.40 ms |    0.39 ms |
...
| native sync bytes             |    858,561 |  337,476 |   337,476 |    337,111 |    199,193 |    198,883 |    198,905 |    199,084 |
