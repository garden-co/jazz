...
namespace margelo::nitro::cojson_core_rn {
  ...
  class HybridCoJSONCoreRNSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual TransactionResult addNewPrivateTransaction(const SessionLogHandle& handle, const std::string& changesJson, const std::string& signerSecret, const std::string& encryptionKey, const std::string& keyId, double madeAt) = 0;
      virtual TransactionResult addNewTrustingTransaction(const SessionLogHandle& handle, const std::string& changesJson, const std::string& signerSecret, double madeAt) = 0;
