...
export declare class NapiRuntime {
  ...
  query(queryJson: string, sessionJson?: string | undefined | null, settledTier?: string | undefined | null, optionsJson?: string | undefined | null): Promise<any>
  subscribe(queryJson: string, onUpdate: (...args: any[]) => any, sessionJson?: string | undefined | null, settledTier?: string | undefined | null, optionsJson?: string | undefined | null): number
