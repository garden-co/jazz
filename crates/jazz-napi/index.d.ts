...
export declare class DevServer {
  static start(options: { appId: string; port?: number; dataDir?: string; inMemory?: boolean; jwksUrl?: string; allowLocalFirstAuth?: boolean; backendSecret?: string; adminSecret?: string; upstreamUrl?: string; telemetryCollectorUrl?: string }): Promise<DevServer>
  get appId(): string
  get url(): string
  get port(): number
  get dataDir(): string
...
export declare class NapiRuntime {
  ...
  restore(table: string, objectId: string, values: Record<string, unknown>): any
  restoreWithSession(table: string, objectId: string, values: Record<string, unknown>, writeContextJson?: string | undefined | null): any
