...
export declare class DevServer {
  static start(options: { appId: string; port?: number; dataDir?: string; inMemory?: boolean; jwksUrl?: string; allowLocalFirstAuth?: boolean; backendSecret?: string; adminSecret?: string; catalogueAuthority?: 'local' | 'forward'; catalogueAuthorityUrl?: string; catalogueAuthorityAdminSecret?: string }): Promise<DevServer>
  get appId(): string
  get url(): string
  get port(): number
  get dataDir(): string
...
export declare class NapiRuntime {
  ...
  getSchema(): any
  get returnsDeclaredSchemaRows(): boolean
