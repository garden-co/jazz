...
export declare class JazzServer {
  static start(options: { appId: string; port?: number; dataDir?: string; inMemory?: boolean; jwksUrl?: string; allowLocalFirstAuth?: boolean; backendSecret?: string; adminSecret?: string; upstreamUrl?: string; telemetryCollectorUrl?: string }): Promise<JazzServer>
  get appId(): string
  get url(): string
  get port(): number
  get dataDir(): string
