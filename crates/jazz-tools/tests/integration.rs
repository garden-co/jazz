...
async fn test_stream_connection_receives_connected_event() {
    ...
    let auth = AuthConfig {
        ...
        local_mode: Some("anonymous".to_string()),
        local_token: Some("stream-test-user".to_string()),
    };
...
async fn test_stream_heartbeat() {
    ...
    let auth = AuthConfig {
        ...
        backend_session: None,
        local_mode: Some("anonymous".to_string()),
        local_token: Some("stream-heartbeat-user".to_string()),
    };
...
async fn test_sync_payload_broadcast_to_stream_client() {
    ...
    let auth = AuthConfig {
        ...
        backend_session: None,
        local_mode: Some("anonymous".to_string()),
        local_token: Some("stream-broadcast-user".to_string()),
    };
