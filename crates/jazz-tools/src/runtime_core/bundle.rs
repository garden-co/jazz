...
impl<S: Storage, Sch: Scheduler> RuntimeCore<S, Sch> {
    ...
    /// `session` — the catalogue head plus the permission-filtered rows — ready
    /// to ship to a cold client for SSR hydration. Non-destructive: outbound
    /// sync already queued for live peers is left in place.
