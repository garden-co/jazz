...
use super::SchemaManagerCatalogueStorage;
...
pub fn latest_catalogue_content<S: SchemaManagerCatalogueStorage + ?Sized>(
    storage: &S,
    object_id: ObjectId,
...
pub fn rehydrate_schema_manager_from_catalogue<S: SchemaManagerCatalogueStorage + ?Sized>(
