      ...
      queries: [
        {
          ...
          expr: `probe_success{instance="https://sync.jazz.tools/self-sync-check", job="self-sync-check", probe=~"${PROBES.join("|")}"}`,
          instant: true,
          refId: "up",
        },
        {
          ...
          expr: `1000 * sum(avg_over_time(probe_duration_seconds{instance="https://sync.jazz.tools/self-sync-check", job="self-sync-check", probe=~"${PROBES.join("|")}"}[$__interval])) by (probe) / 2`,
          instant: false,
          range: true,
          interval: "15m",
        ...
        },
        {
          ...
          expr: `1000 * avg(avg_over_time(probe_duration_seconds{instance="https://sync.jazz.tools/self-sync-check", job="self-sync-check", probe=~"${PROBES.join("|")}"}[$__range])) by (probe) / 2`,
          instant: true,
          refId: "avg_latency",
        },
        {
          ...
          expr: `1000 * histogram_quantile(0.95, sum(rate(probe_all_duration_seconds_bucket{instance="https://sync.jazz.tools/self-sync-check", job="self-sync-check", probe=~"${PROBES.join("|")}"}[$__range])) by (le, probe)) / 2`,
          instant: true,
          refId: "p99_latency",
        },
      ],
