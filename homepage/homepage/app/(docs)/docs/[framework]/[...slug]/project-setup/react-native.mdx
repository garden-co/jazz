...
<CodeGroup>
  ```json "expo": "~51.0.0", "react-native": "~0.74.5", "react": "^18.2.0", ```
</CodeGroup>
...
<CodeGroup>
  ```bash npx create-expo-app -e with-router-tailwind my-jazz-app cd my-jazz-app
  npx expo prebuild ```
</CodeGroup>
...
<CodeGroup>```bash npx pod-install ```</CodeGroup>
