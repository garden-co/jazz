...
export function Pricing() {
  return (
    <>
      ...
      <div className="rounded-xl border bg-linear-to-r from-stone-50 to-gray-50 p-6 shadow-xs shadow-gray-900/5 dark:from-stone-925 dark:to-stone-950">
      ...
      <div className="mb-10 grid gap-4 md:grid-cols-3">
        <div className="flex flex-col items-start gap-3 rounded-xl border bg-stone-100 p-6 shadow-xs shadow-gray-900/5 dark:bg-stone-925">
          <h3 className="flex w-full items-center justify-between text-xl font-semibold text-stone-900 dark:text-white">
            <span className="flex items-center gap-1.5">
              <StarterTierLogo />
              Starter
