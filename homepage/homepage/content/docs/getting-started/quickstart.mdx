...
import { CodeGroup, ContentByFramework, FileName, JazzLogo, TabbedCodeGroup, TabbedCodeGroupItem, StuckCTA } from "@/components/forMdx";
...
## Next steps
- [Add authentication](/docs/authentication/overview) to your app so that you can log in and view your data wherever you are!
