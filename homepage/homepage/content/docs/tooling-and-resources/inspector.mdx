...
The Inspector includes a Performance tab that helps you analyze the runtime behavior of your Jazz app. To enable performance recording, you need to call `recordMetrics()` at the start of your application.

### Enabling performance recording

Import and call `recordMetrics()` before your app renders:

<CodeGroup>
```tsx index.tsx#RecordMetrics
```
</CodeGroup>

### What gets tracked

Once enabled, the Performance tab displays several metrics:
