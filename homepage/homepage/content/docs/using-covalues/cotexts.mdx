...
export const metadata = {
  description: "CoPlainText and CoRichText enable real-time collaborative text editing. They provide fine-grained control over text edits, and efficient merging of concurrent changes."
};
