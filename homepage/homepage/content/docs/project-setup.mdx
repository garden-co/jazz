...
<CodeGroup>
```ts snippet=project-setup/schema.ts
```
</CodeGroup>
...
```tsx snippet=project-setup/app.tsx
```
</TabbedCodeGroupItem>
<TabbedCodeGroupItem label="Svelte" value="svelte" icon={<SvelteLogo />} preferWrap>
```svelte snippet=project-setup/+layout.svelte
```
</TabbedCodeGroupItem>
</TabbedCodeGroup>
...
<TabbedCodeGroupItem label="React" value="react" icon={<ReactLogo />} preferWrap>
```ts snippet=project-setup/JazzWrapper.tsx
```
</TabbedCodeGroupItem>
<TabbedCodeGroupItem label="Svelte" value="svelte" icon={<SvelteLogo />} preferWrap>
```svelte snippet=project-setup/+layout-with-ssr.svelte
```
</TabbedCodeGroupItem>
</TabbedCodeGroup>
...
<TabbedCodeGroupItem label="React" value="react" icon={<ReactLogo />} preferWrap>
```tsx snippet=project-setup/page.tsx
```
</TabbedCodeGroupItem>
<TabbedCodeGroupItem label="Svelte" value="svelte" icon={<SvelteLogo />} preferWrap>
```svelte snippet=project-setup/+page.svelte
```
</TabbedCodeGroupItem>
</TabbedCodeGroup>
