...
- We have introduced a way to permanently [delete CoValues](/docs/react/core-concepts/deleting). This brings a new `deleted` loading state. See [New `deleted` loading state](#new-deleted-loading-state).
