...
We submitted [a fix](https://github.com/microsoft/TypeScript/pull/62661) for this bug, which is available in TypeScript 6.0. If you are on a previous version, use one of the following workarounds if you encounter this issue:
