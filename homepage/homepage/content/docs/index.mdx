...
<Alert variant="info" title="Using Jazz Cloud">
  These two iframes are syncing through the Jazz Cloud. You can use the toggle in the top right hand side to enable or disable sync, and see how you can continue working even without network connectivity.
</Alert>
