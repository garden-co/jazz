...
1. [Node-API crypto](/docs/server-side/setup#node-api) (only available in some Node/Deno environments) and [RNCrypto](/docs/project-setup/providers#rncrypto) on React Native
...
<CodeGroup>
```ts index.ts#ReuseOwnerOnInlineCreation
```
</CodeGroup>
