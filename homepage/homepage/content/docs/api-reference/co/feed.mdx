...
<JazzDefaultProperties item="Feed" level={4}  />
...
- `listener`: A callback function that receives the resolved `CoFeed` and an `unsubscribe` function.
