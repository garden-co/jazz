...
```ts snippet=quickstart/schema.ts
```
</CodeGroup>
...
<CodeGroup preferWrap>
```tsx snippet=quickstart/JazzWrapper.tsx
```
</CodeGroup>
</ContentByFramework>
<ContentByFramework framework="react">
...
<TabbedCodeGroupItem label="React" value="react" icon={<ReactLogo />} preferWrap>
  ```tsx snippet=quickstart/layout.tsx
  ```
</TabbedCodeGroupItem>
<TabbedCodeGroupItem label="Svelte" value="svelte" icon={<SvelteLogo />} preferWrap>
```svelte snippet=quickstart/+layout.svelte
```
</TabbedCodeGroupItem>
</TabbedCodeGroup>
...
>
<TabbedCodeGroupItem label="React" value="react" icon={<ReactLogo />} preferWrap>
```tsx snippet=quickstart/NewBand.tsx
```
</TabbedCodeGroupItem>
<TabbedCodeGroupItem label="Svelte" value="svelte" icon={<SvelteLogo />} preferWrap>
```svelte snippet=quickstart/NewBand.svelte
```
</TabbedCodeGroupItem>
</TabbedCodeGroup>
...
```tsx snippet=quickstart/Festival.tsx
```
</TabbedCodeGroupItem>
<TabbedCodeGroupItem icon={<SvelteLogo />} label="Svelte" value="svelte" preferWrap>
```svelte snippet=quickstart/Festival.svelte
```
</TabbedCodeGroupItem>
</TabbedCodeGroup>
...
<TabbedCodeGroupItem label="React" value="react" icon={<ReactLogo />} preferWrap>
```tsx snippet=quickstart/page.tsx
```
</TabbedCodeGroupItem>
<TabbedCodeGroupItem icon={<SvelteLogo />} label="Svelte" value="svelte" preferWrap>
```svelte snippet=quickstart/+page.svelte
```
</TabbedCodeGroupItem>
</TabbedCodeGroup>
