...
<CodeGroup>
```ts snippet=core-concepts/covalues/cotexts/index.ts region=Basic
```
</CodeGroup>
...
<CodeGroup>
```ts snippet=core-concepts/covalues/cotexts/index.ts region=Comparison
```
</CodeGroup>
...
<CodeGroup>
```ts snippet=core-concepts/covalues/cotexts/index.ts region=StringInitial
```
</CodeGroup>
...
<CodeGroup>
```ts snippet=core-concepts/covalues/cotexts/index.ts region=Ownership
```
</CodeGroup>
...
<CodeGroup>
```ts snippet=core-concepts/covalues/cotexts/index.ts region=Reading
```
</CodeGroup>
...
<CodeGroup>
```tsx snippet=core-concepts/covalues/cotexts/react.tsx region=JSX
```
</CodeGroup>
</ContentByFramework>
...
<CodeGroup>
```ts snippet=core-concepts/covalues/cotexts/index.ts region=Editing
```
</CodeGroup>
...
<CodeGroup>
```ts snippet=core-concepts/covalues/cotexts/index.ts region=ApplyDiff
```
</CodeGroup>
...
<ContentByFramework framework="react">
<CodeGroup>
```ts snippet=core-concepts/covalues/cotexts/react.tsx region=TextEditor
```
</CodeGroup>
</ContentByFramework>
...
<CodeGroup>
```ts snippet=core-concepts/covalues/cotexts/vanilla.ts region=PlainText
```
</CodeGroup>
</ContentByFramework>
...
<CodeGroup>
  ```svelte snippet=core-concepts/covalues/cotexts/svelte.svelte
  ```
</CodeGroup>
</ContentByFramework>
...
For use with React:
<CodeGroup>
```tsx snippet=core-concepts/covalues/cotexts/react.tsx
```
</CodeGroup>
</ContentByFramework>
...
<CodeGroup>
```ts snippet=core-concepts/covalues/cotexts/vanilla.ts region=RichText
```
</CodeGroup>
</ContentByFramework>
