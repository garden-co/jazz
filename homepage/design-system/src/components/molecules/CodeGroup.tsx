...
export function CopyButton({
  ...
  return (
    <button
      ...
      className={clsx(
        className,
        "group/button absolute overflow-hidden rounded-xs text-2xs font-medium md:opacity-0 backdrop-blur-xs transition md:focus:opacity-100 group-hover:opacity-100 items-center align-middle p-0",
        copied
