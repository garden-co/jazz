      ...
      <div className="z-50 fixed inset-0 w-screen overflow-y-auto px-3 flex flex-col pt-8 sm:pt-16 lg:pt-32">
        <Headless.DialogPanel
          ...
          className={clsx(
            className,
            sizes[size],
            "mx-auto w-full min-w-0 rounded-2xl bg-white p-[--gutter] shadow-lg ring-1 ring-stone-950/10 [--gutter:theme(spacing.6)] sm:mb-auto sm:rounded-2xl dark:bg-stone-950 dark:ring-white/10 forced-colors:outline",
