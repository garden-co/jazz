...
export const glassButtonBaseClasses =
  "relative backdrop-blur-sm overflow-hidden transition-all duration-400 [transition-timing-function:cubic-bezier(0.175,0.885,0.32,2.2)] border-0 bg-gradient-to-br shadow-[0_6px_6px_rgba(0,0,0,0.2),0_0_20px_rgba(0,0,0,0.1)]";

export const styleToGlassButtonClassMap = {
  primary: `${glassButtonBaseClasses} from-primary-light to-primary-dark hover:from-primary-light hover:to-primary-dark active:from-primary-light active:to-primary-dark shadow-[inset_0_0_0_0.4px_rgba(59,130,246,0.2),inset_0_0.4px_0_rgba(147,197,253,0.4),inset_0_-0.4px_0_rgba(30,64,175,0.3)]`,
  info: `${glassButtonBaseClasses} from-info-light to-info-dark hover:from-info-light hover:to-info-dark active:from-info-light active:to-info-dark shadow-[inset_0_0_0_0.4px_rgba(147,51,234,0.2),inset_0_0.4px_0_rgba(221,214,254,0.4),inset_0_-0.4px_0_rgba(88,28,135,0.3)]`,
  success: `${glassButtonBaseClasses} from-success-light to-success-dark hover:from-success-light hover:to-success-dark active:from-success-light active:to-success-dark shadow-[inset_0_0_0_0.4px_rgba(34,197,94,0.2),inset_0_0.4px_0_rgba(187,247,208,0.4),inset_0_-0.4px_0_rgba(22,101,52,0.3)]`,
  warning: `${glassButtonBaseClasses} from-warning-light to-warning-dark hover:from-warning-light hover:to-warning-dark active:from-warning-light active:to-warning-dark shadow-[inset_0_0_0_0.4px_rgba(249,115,22,0.2),inset_0_0.4px_0_rgba(254,240,138,0.4),inset_0_-0.4px_0_rgba(154,52,18,0.3)]`,
  danger: `${glassButtonBaseClasses} from-danger-light to-danger-dark hover:from-danger-light hover:to-danger-dark active:from-danger-light active:to-danger-dark shadow-[inset_0_0_0_0.4px_rgba(239,68,68,0.2),inset_0_0.4px_0_rgba(254,202,202,0.4),inset_0_-0.4px_0_rgba(153,27,27,0.3)]`,
  alert: `${glassButtonBaseClasses} from-alert-light to-alert-dark hover:from-alert-light hover:to-alert-dark active:from-alert-light active:to-alert-dark shadow-[inset_0_0_0_0.4px_rgba(234,179,8,0.2),inset_0_0.4px_0_rgba(254,249,195,0.4),inset_0_-0.4px_0_rgba(133,77,14,0.3)]`,
  tip: `${glassButtonBaseClasses} from-tip-light to-tip-dark hover:from-tip-light hover:to-tip-dark active:from-tip-light active:to-tip-dark shadow-[inset_0_0_0_0.4px_rgba(6,182,212,0.2),inset_0_0.4px_0_rgba(207,250,254,0.4),inset_0_-0.4px_0_rgba(21,94,117,0.3)]`,
  muted: `${glassButtonBaseClasses} from-stone-300 to-stone-600 hover:from-stone-300 hover:to-stone-600 active:from-stone-300 active:to-stone-600 shadow-[inset_0_0_0_0.4px_rgba(120,113,108,0.2),inset_0_0.4px_0_rgba(245,245,244,0.4),inset_0_-0.4px_0_rgba(68,64,60,0.3)]`,
  strong: `${glassButtonBaseClasses} from-stone-700 to-stone-900 hover:from-stone-700 hover:to-stone-900 active:from-stone-700 active:to-stone-900 shadow-[inset_0_0_0_0.4px_rgba(68,64,60,0.2),inset_0_0.4px_0_rgba(168,162,158,0.4),inset_0_-0.4px_0_rgba(41,37,36,0.3)]`,
  default: `${glassButtonBaseClasses} from-stone-200 to-stone-400 hover:from-stone-200 hover:to-stone-400 active:from-stone-200 active:to-stone-400 shadow-[inset_0_0_0_0.4px_rgba(255,255,255,0.2),inset_0_0.4px_0_rgba(255,255,255,0.4),inset_0_-0.4px_0_rgba(156,163,175,0.3)]`,
};
