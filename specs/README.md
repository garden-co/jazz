...
- **[Unified CRUD API](todo/a_mvp/unified_crud_api.md)** — collapse plain, durable, and persisted writes into one mutation surface with per-call `wait` and restart-safe late error reporting
