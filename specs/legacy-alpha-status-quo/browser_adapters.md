...
- durable local batch records, authoritative settlements, and sealed batch submissions
...
4. Worker persists the row-batch and any replayable batch bookkeeping.
