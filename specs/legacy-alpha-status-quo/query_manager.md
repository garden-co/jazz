...
Current maintained-view invariants live in `crates/groove/SPEC/INVARIANTS.md`
and `crates/jazz/SPEC/16_maintained_subscription_views.md`; this legacy note is
...
Current policy composition semantics live in `crates/jazz/SPEC/7_authorization.md`
and lowering details live in `crates/jazz/SPEC/14_lowering_to_groove.md`.
