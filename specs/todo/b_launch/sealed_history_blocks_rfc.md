...
Prototype note: newly sealed blocks now use a v7 `columnar-json-lz4` payload.
...
body. The v7 payload dictionary-codes repeated string columns such as table ids,
...
The decoder still accepts the earlier `bundle-json-lz4` v1 blocks and v3 / v4 /
v5 / v6 columnar blocks for compatibility within the spike.
