...
Currently, subscriptions wait for settlement before delivering results. For large result sets, the client may want to start processing data as it arrives rather than waiting for the full initial batch.
...
Related future work: file/blob transfer over relational subscriptions.
