...
- The legacy `useLinkExternalIdentity` in `packages/jazz-tools/src/{react,svelte,vue}/use-link-external-identity.ts` targets the old synthetic-users/demoAuth path and is being removed. It is not a solution.
