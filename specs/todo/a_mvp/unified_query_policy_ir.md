...
- Policy relation construction is still TS-side (separate from app query builder internals), though now as direct relation-expression state instead of plan variants.
